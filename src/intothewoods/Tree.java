...
public class Tree {
	...
	private static final String NO_LABELS_EXCEPTION = "Non � possibile generare un albero casuale senza definire le etichette da utilizzare.";
	private static final String NOT_ENOUGH_NODES_EXCEPTION = "Non � possibile generare un albero poich� il numero di nodi richiesto non basta per utilizzare tutte le etichette.";
	 ...
	 * Questo assicura che l'albero conterr� sicuramente almeno un nood per ciascuna etichetta della lista.
	...
	/**
	 * Verifica se all'interno dell'albero � presente almeno un nodo
